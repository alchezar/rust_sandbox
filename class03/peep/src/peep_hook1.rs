...
use windows::Win32::UI::WindowsAndMessaging::{
	DispatchMessageW, EVENT_SYSTEM_FOREGROUND, GetMessageW, GetWindowThreadProcessId, MSG, TranslateMessage,
...
unsafe extern "system" fn window_change_callback(
	...
	let process = match unsafe { OpenProcess(PROCESS_QUERY_INFORMATION | PROCESS_VM_READ, false, pid) } {
		Ok(handle) => handle,
